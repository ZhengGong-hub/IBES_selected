...
rec_grouped_analyst_coverage = rec.groupby(by=['ANALYST', 'TICKER']).count()[['CUSIP']].rename(columns={'CUSIP' : 'COUNT_RECOM'})
...
tp_grouped_analyst_coverage = tp.groupby(by=['ANALYST', 'TICKER']).count()[['CUSIP']].rename(columns={'CUSIP' : 'COUNT_RECOM'})
